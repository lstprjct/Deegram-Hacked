...
from bot import bot, Interval, INDEX_URL, BUTTON_FOUR_NAME, BUTTON_FOUR_URL, BUTTON_FIVE_NAME, BUTTON_FIVE_URL, \
                ...
                MIRROR_ENABLED, LEECH_ENABLED, WATCH_ENABLED, CLONE_ENABLED, LINK_LOGS, LOG_CHAT_URL
    ...
    def onUploadComplete(self, link: str, size, files, folders, typ, name: str):
        ...
        if AUTO_DELETE_UPLOAD_MESSAGE_DURATION != -1:
            ...
            if self.message.chat.type == 'private':
                ...
                warnmsg = f'This message will be deleted in <i>{auto_delete_message} minutes</i> from this group.</b>\n'
        else:
            warnmsg = ''
        ...
        if MIRROR_LOGS and self.message.chat.type != 'private':
            logwarn = f'I have sent files in <a href="{LOG_CHAT_URL}">Mirror Log Channel<a\>'
        elif self.message.chat.type == 'private':
            logwarn = ''
        else:
            logwarn = ''
        if LEECH_LOG and self.message.chat.type != 'private':
            logleechwarn = f'I have sent files in <a href="{LOG_CHAT_URL}">Leech Log Channel<a\>'
        elif self.message.chat.type == 'private':
            logleechwarn = ''
        else:
            logleechwarn = ''
